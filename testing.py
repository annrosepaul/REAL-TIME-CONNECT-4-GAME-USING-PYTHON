...
class game:
    ...
    def __init__(self):    # self : placeholder that refers to the instance of the class itself
        ...
        self.SOUND = 'ON'  # Initialize SOUND attribute
        self.MUSIC = 'ON'  # Initialize MUSIC attribute
        self.PLAY_BGM_MENU = False  # Initialize PLAY_BGM_MENU attribute
        self.PLAY_BGM_Mode_Simple = False  # Initialize PLAY_BGM_Mode_Simple attribute
        self.PLAY_BGM_Mode_Complex = False  # Initialize PLAY_BGM_Mode_Complex attribute
        self.AUDIO_BGM_Menu = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Menu.mp3')  # Load your background music file
        self.AUDIO_BGM_Mode_Simple = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Mode_Simple.mp3')  # Load your simple mode sound file
        self.AUDIO_BGM_Mode_Complex = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Mode_complex.mp3')  # Load your complex mode sound file
        
        #simple mode music file
        self.scores = [0, 0]
    ...
    def draw_scoreboard(self):
        score_text = self.FONT.render(f"Player 1: {self.scores[0]}  Player 2: {self.scores[1]}", True, (255, 255, 255))
       ...
       # LOGO
        self.IMPORT_LOGO_HIDDEN_BLADE = pygame.image.load(r'Asset Connect 4\Logo_Hidden_Blade.jpg')

        # ICONS
        self.IMPORT_ICONS_THEME_NEON = pygame.image.load(r'Asset Connect 4\Theme_Neon.png')
        self.IMPORT_ICONS_THEME_DARK = pygame.image.load(r'Asset Connect 4\Theme_Dark.png')
        self.IMPORT_ICONS_MUSIC_ON = pygame.image.load(r'Asset Connect 4\Music_ON.png')
        self.IMPORT_ICONS_MUSIC_OFF = pygame.image.load(r'Asset Connect 4\Music_OFF.png')
        self.IMPORT_ICONS_SOUND_ON = pygame.image.load(r'Asset Connect 4\Sound_Effect_ON.png')
        self.IMPORT_ICONS_SOUND_OFF = pygame.image.load(r'Asset Connect 4\Sound_Effect_OFF.png')
        

        # BACKGROUNDS
        self.IMPORT_BACKGROUND_MENU_NEON = pygame.image.load(r'Asset Connect 4\Background Images\Menu_Neon.jpg')
        self.IMPORT_BACKGROUND_MENU_DARK = pygame.image.load(r'Asset Connect 4\Background Images\Menu_Dark.jpg')
        self.IMPORT_BACKGROUND_GAME_NEON = pygame.image.load(r'Asset Connect 4\Background Images\Game Background.jpg')
        self.IMPORT_BACKGROUND_GAME_DARK = pygame.image.load(r'Asset Connect 4\Background Images\Game Mode Background-3.jpg')
        self.IMPORT_BACKGROUND_GAME_MODE = pygame.image.load(r'Asset Connect 4\Background Images\Game Mode.jpg')
        self.IMPORT_BACKGROUND_RESULT = pygame.image.load(r'Asset Connect 4\Background Images\Result Background.jpg')
        self.IMPORT_CREDITS = pygame.image.load(r"Asset Connect 4\credits.png")

        # PLAYERS IMAGES
        self.IMPORT_IMAGE_PLAYER_X = pygame.image.load(r'Asset Connect 4\Player X.png')
        self.IMPORT_IMAGE_PLAYER_O = pygame.image.load(r'Asset Connect 4\Player O.png')
 
        # AUDIOS
        self.AUDIO_BGM_Menu = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Menu.mp3')
        self.AUDIO_BGM_Mode_Simple = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Mode_Simple.mp3')
        self.AUDIO_BGM_Mode_Complex = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\BGM_Mode_Complex.mp3')
        self.AUDIO_SEFX_BUTTON_CLICK = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\SEFX_Button_Click.wav')
        self.AUDIO_SEFX_XO_INSERT = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\SEFX_XO_Insert.wav')
        self.AUDIO_SEFX_WIN = pygame.mixer.Sound(r'Asset Connect 4\Sounds_&_Effects\SEFX_Win.wav')
        # self.AUDIO_SEFX_GRAVITY = pygame.mixer.Sound(r'Python\Games\Connet 4\Asset Connect 4\Sounds_&_Effects\SEFX_Gravity.wav')
        
        self.IMPORT_SOUND_DRAW_PLAYER = pygame.mixer.Sound(r'Asset Connect 4\Draw Player.mp3')
        self.IMPORT_SOUND_END = pygame.mixer.Sound(r'Asset Connect 4\End Sound.mp3')

        # FONTS
        self.FONT_EXIT_BOX = pygame.font.SysFont('font.ttf', 40)      # SysFont("FontName, FontSize")
        self.FONT_EXIT_BOX_OPTONS = pygame.font.SysFont('font.ttf', 35)      # SysFont("FontName, FontSize")
        self.FONT_RESTART_WIN = self.FONT_EXIT_BOX
        self.FONT_RESTART_WIN_OPTIONS = self.FONT_EXIT_BOX_OPTONS
        self.FONT_RESTART_BOX = pygame.font.SysFont('font.ttf', 40)
        ...
        self.FONT_MENU_CONNECT_4= pygame.font.Font(r"Asset Connect 4\Fonts\neuropolitical rg.otf",50)   # pygame.font.Font(font_path, font_size)
        self.FONT_MENU_OPTIONS = pygame.font.SysFont('font.ttf', 40)
    ...
    def main(self):
        while True:
            self.draw_scoreboard()  # Call the method
    ...
    def audio(self,PLAY_SEFX_BUTTON_CLICK = False, PLAY_SEFX_XO_INSERT = False, PLAY_SEFX_WIN = False, SOUND_UPDATE = False):
        ...
        if (self.SOUND == 'ON' or SOUND_UPDATE):
            ...
            if self.SOUND == 'ON' or SOUND_UPDATE:
                self.PLAY_BGM_MENU
                self.AUDIO_BGM_Menu.play(-1)  # Play background music
            elif self.PLAY_BGM_Mode_Simple:                                    #edited from 170 to 176
                self.AUDIO_BGM_Mode_Simple.play(-1) 
            elif self.PLAY_BGM_Mode_Complex:
                self.AUDIO_BGM_Mode_Complex.play(-1)
            else:
                self.AUDIO_BGM_Menu.stop()  # Stop background music
    ...
    def draw_WIN(self, DRAW_PLAYER_IMAGE = (False, None, None), DRAW_EXIT_WIN = False, DRAW_RESTART_WIN = False, DRAW_MENU = False, DRAW_MENU_SETTINGS = False, DRAW_CREDITS = False, DRAW_GAME_MODE = False, DRAW_GAME_MODE_SPECIAL = False, DRAW_RESULT=(False, None), DRAW_RESTART_BOX = {'DRAW': False, 'RETURN_VALUE': False}, DRAW_PLAYER_MOVE_BOX = {'DRAW': False, 'RETURN_VALUE': False}, DRAW_GRAVITY_BOX =  {'DRAW': False, 'RETURN_VALUE': False}, DRAW_CREDITS_BOX =  {'DRAW': False, 'RETURN_VALUE': False}) :
        ...
        if DRAW_MENU:
            ...
            MENU_LOGO_X_CORRIDINATE = (self.WIDTH - self.LOGO_HIDDEN_BLADE.get_width())/-1  
        ...
        if DRAW_CREDITS_BOX['DRAW'] or DRAW_CREDITS_BOX['RETURN_VALUE']:
            ...
            CREDITS_BOX_Ln1_TEXT = self.FONT_CERDITS_Title_BOX.render(" CREATED FOR ", 1, self.BLACK)
            CREDITS_BOX_Ln2_TEXT = self.FONT_CERDITS_Name_BOX.render(" MCA PROJECT ", 1, self.BLACK) 
            ...
            for EVENT in pygame.event.get():
                ...
                if STATUS['INSERT_SUCCESS'] is False:
                    ...
                    if STATUS['PLAYER'] == self.PLAYER_X:
                        ...
                        self.audio()
                        self.AUDIO_SEFX_WIN.play()
                        self.RESTART = self.result_WIN('PLAYER 1')
                        ...
                        self.audio()
                        self.AUDIO_SEFX_WIN.play()
                        self.RESTART = self.result_WIN('PLAYER 2')
